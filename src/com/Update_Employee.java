...
public class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        id = new JLabel("Update Employee Detail:");
        id.setBounds(50,10,500,50);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+t3.getText()+"',dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',education='"+t8.getText()+"',post='"+t9.getText()+"',aadhar='"+t10.getText()+"',emp_id='"+t11.getText()+"' where emp_id='"+id_emp+"'";
